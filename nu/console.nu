...
(class NuConsoleViewController is NSObject
 (ivar (id) textview 
       (id) startOfInput (id) insertionPoint (id) parser (id) history (id) index (id) count (id) chunk)
 ...
 (- (id) initWithFrame:(NSRect) frame is
    ...
    (@textview set:     (backgroundColor: (NSColor colorWithDeviceRed:0.8 green:0.8 blue:1.0 alpha:0.9)
 ...
 (- (BOOL) textView:(id) textview shouldChangeTextInRange:(NSRange) range replacementString:(id) replacement is
    ((@textview layoutManager) removeTemporaryAttribute:"NSColor" 
                                      forCharacterRange:(list 0 (self lengthOfTextView)))
    ((@textview layoutManager) removeTemporaryAttribute:"NSBackgroundColor" 
                                      forCharacterRange:(list 0 (self lengthOfTextView)))
    ((@textview layoutManager) removeTemporaryAttribute:"NSFont" 
                                      forCharacterRange:(list 0 (self lengthOfTextView)))
